...
public class Home_TwoFragment_Adapter extends BaseAdapter {
    ...
    public Home_TwoFragment_Adapter(Context applicationContext, int simple_list_item_1, List<String> output) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        view = inflater.inflate(R.layout.fragment_home_two_gridtext, null);
