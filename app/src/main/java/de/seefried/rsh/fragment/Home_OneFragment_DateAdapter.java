...
public class Home_OneFragment_DateAdapter extends BaseAdapter {
    ...
    public Home_OneFragment_DateAdapter(Context applicationContext, int simple_list_item_1, List<String> output) {
